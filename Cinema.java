...
public class Cinema
{
    public static void main (String[] args)
    {
        ...
        ArrayList<CinemaBookingSystem> bookings = new ArrayList<CinemaBookingSystem>();
	    ...
	    if(option==3)
	    {
	        ...
	        do 
	        {
	            ...
	            System.out.println();
	            CinemaBookingSystem booking = new CinemaBookingSystem(customer, shows.get(showNumber-1));
	        ...
	        System.out.println("-------------------------");
                ...
                for (CinemaBookingSystem booking : bookings)
                {
